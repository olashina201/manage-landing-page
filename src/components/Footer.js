        ...
        <footer>
            ...
            <div className="footer-container__social">
                <div className="copyright">
                    ...
                    <span>Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>. Coded by <a href="https://github.com/olashina201" target="_blank">Olashina</a>.</span>
                </div>
            ...
            <div className="footer-container__input">
                <form className="email-form">
                    ...
                    <input className="email-submit" type="submit" value="Go" />
                </form>
                <div className="copyright">
                    <span>Copyright 2020. All Rights Reserved</span>
                    <span>Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>. Coded by <a href="https://github.com/rontoyhacao" target="_blank">Ron Paolo Toyhacao</a>.</span>
                </div>
            </div>
            </div>
        </footer>
